...
if (!$SoMeSettings['SharePin'] == "#PinURL") {echo "<a target=\"DpMbEx\" href=\"".$SoMeSettings['SharePin']."\"><img src=\"https://shields.io/badge/".$localeSoMePhrases['PinOnPinterest']."-Pinterest-red?&style=plastic&logo=Pinterest&logoColor=BD081C&colorA=$bgcolorSafeAndShare&colorB=BD081C\"></a>";}
