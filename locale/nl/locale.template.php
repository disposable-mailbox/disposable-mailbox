...
W&auml;hlen Sie einfach eine Adresse und verwenden Sie sie auf Websites, 
denen Sie nicht vertrauen und wo Sie die Private Haupt-E-Mail-Adresse nicht preisgeben wollen. <br/>Sobald Sie fertig sind, können Sie die Mailbox einfach vergessen. <br/> Der ganze Spam bleibt hier wird nicht im Privaten Mailaccount landen.</p>";
// $ locale ['long-about-2'] = "<p class = \" text-justify \ "> Kies gewoon een adres en gebruik het op websites die u niet vertrouwt en waar u de privé hoofd-e-  Wil je je e-mailadres niet prijsgeven. <br/> Zodra je klaar bent, kun je je mailbox gewoon vergeten. <br/> Alle spam die hier blijft, komt niet in je privé-mailaccount terecht. </p> ";
